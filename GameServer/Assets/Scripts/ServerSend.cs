...
public class ServerSend
{
    ...
    public static void ObjectPosition(ObjectMovement _objmov)
    {
        using (Packet _packet = new Packet((int)ServerPackets.ObjectPosition))

        {
            _packet.Write(_objmov.id);
            _packet.Write(_objmov.transform.position);

            SendTCPDataToAll(_packet);
        }
    }
    public static void ObjectRotation(ObjectMovement _objmov)
    {
        using (Packet _packet = new Packet((int)ServerPackets.ObjectRotation))

        {
            _packet.Write(_objmov.id);
            _packet.Write(_objmov.transform.rotation);
